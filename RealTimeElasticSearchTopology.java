	...
	**/
    ...
    public static void main(String[] args) throws Exception {
	   ...
	   ***/
	   ...
	   String query4 = QueryBuilders.fuzzyQuery("text","man").buildAsBytes().toUtf8();
	   String query5 = QueryBuilders.prefixQuery("text","is").buildAsBytes().toUtf8();
	   String query6 = QueryBuilders.wildcardQuery("text","f*").buildAsBytes().toUtf8();
       String drpcResult;
       ...
       for (int i = 0; i < 30; i++) {
          ...
          System.out.println("DRPC RESULT prefixQuery: " + drpcResult);
